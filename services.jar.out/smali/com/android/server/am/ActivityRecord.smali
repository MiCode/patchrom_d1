...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ProcessRecord;ILandroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZ)V
    ...
    iput-boolean v3, p0, Lcom/android/server/am/ActivityRecord;->mBacklightSelect:Z
    ...
    .line 342
    sget-boolean v3, Lcom/android/server/am/ActivityRecord;->mCommunicationCreated:Z
    ...
    sput-boolean v3, Lcom/android/server/am/ActivityRecord;->mCommunicationCreated:Z
...
.method final createSocketCommunication()V
    ...
    :cond_3
    :goto_3
    sput-object v6, Lcom/android/server/am/ActivityRecord;->mLocalSocket:Landroid/net/LocalSocket;

    .line 689
    sput-object v6, Lcom/android/server/am/ActivityRecord;->mOutputStream:Ljava/io/OutputStream;
    ...
    const-string v5, "exception mLocalSocket.close"
    ...
    const-string v5, "exception mOutputStream.close"
...
.method public windowsDrawn()V
    ...
    iget-wide v2, v0, Lcom/android/server/am/ActivityRecord;->launchTime:J
    ...
    iget-wide v2, v2, Lcom/android/server/am/ActivityStack;->mInitialStartTime:J
    ...
    .line 736
    invoke-static {v5, v6, v14}, Landroid/util/TimeUtils;->formatDuration(JLjava/lang/StringBuilder;)V
    ...
    .line 739
    invoke-static {v7, v8, v14}, Landroid/util/TimeUtils;->formatDuration(JLjava/lang/StringBuilder;)V
    ...
    .line 747
    .local v12, currentTime:Ljava/util/Date;
    new-instance v9, Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;

    invoke-direct {v9}, Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;-><init>()V

    .line 749
    .local v9, actPerformanceInfo:Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/am/ActivityRecord;->shortComponentName:Ljava/lang/String;

    iput-object v2, v9, Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;->activityName:Ljava/lang/String;

    .line 750
    move-object/from16 v0, p0

    invoke-virtual {v0, v12}, Lcom/android/server/am/ActivityRecord;->getCurrentTime(Ljava/util/Date;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, v9, Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;->endTime:Ljava/lang/String;
    ...
    iput-wide v2, v9, Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;->consumedTime:J

    .line 752
    const/4 v2, 0x0

    iput v2, v9, Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;->killProcsCount:I
    ...
    iget-wide v0, v9, Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;->consumedTime:J
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/am/ActivityRecord;->getCurrentTime(Ljava/util/Date;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, v9, Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;->startupTime:Ljava/lang/String;

    .line 755
    move-object/from16 v0, p0

    invoke-virtual {v0, v9}, Lcom/android/server/am/ActivityRecord;->sendActivityPerformanceInfo(Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;)V
    ...
    iget-object v2, v2, Lcom/android/server/am/ActivityManagerService;->mUsageStatsService:Lcom/android/server/am/UsageStatsService;
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/server/am/UsageStatsService;->noteLaunchTime(Landroid/content/ComponentName;I)V
    ...
    iput-wide v2, v0, Lcom/android/server/am/ActivityRecord;->launchTime:J
    ...
    iput-wide v3, v2, Lcom/android/server/am/ActivityStack;->mInitialStartTime:J

    .line 766
    .end local v5           #thisTime:J
    .end local v7           #totalTime:J
    .end local v9           #actPerformanceInfo:Lcom/android/server/am/ActivityRecord$ActivityPerformanceInfo;
    .end local v10           #curTime:J
    .end local v12           #currentTime:Ljava/util/Date;
    .end local v13           #index:I
    .end local v14           #sb:Ljava/lang/StringBuilder;
    .end local v15           #startupMillsecond:J
    ...
    iput-wide v2, v0, Lcom/android/server/am/ActivityRecord;->startTime:J
